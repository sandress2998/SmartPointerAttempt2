...
public:
    MutableArraySequence(const T* arrayToCopy, int size): array(makeShared<DynamicArray<T>>(arrayToCopy, size)) {}
    MutableArraySequence(int size): array(makeShared<DynamicArray<T>>(size)) {}
    MutableArraySequence(): array(makeShared<DynamicArray<T>>(0)) {}
    MutableArraySequence(const LinkedList<T>& other): array(makeShared<DynamicArray<T>>(other)) {}
    MutableArraySequence(const DynamicArray<T>& other): array(makeShared<DynamicArray<T>>(other)) {}
    MutableArraySequence(const Sequence<T>& other): array(makeShared<DynamicArray<T>>(other)) {}
    MutableArraySequence(const MutableArraySequence<T>& other): array(makeShared<DynamicArray<T>>(*(other.array))) {}
