...
public:
    ...
    void testAppend() {
        ...
        ImmutableSequence<int> immutSeq(m, length);
        int elem = 100;
        ImmutableSequence<int>* immutSeq2 = immutSeq.append(elem);
    ...
    void testPrepend() {
        ...
        ImmutableSequence<int> immutSeq(m, length);
        int elem = 100;
        ImmutableSequence<int>* immutSeq2 = immutSeq.prepend(elem);
        assert(immutSeq.getLength() == 7);
        assert(immutSeq2->getLength() == 8);
    ...
    void testInsertAt() {
        ...
        ImmutableSequence<int>* immutSeq2{};
        int elem = 100;
        int index = 3;
    ...
    void testConcat() {
        ...
        ImmutableSequence<int>* result = immutSeq1.concat(immutSeq2);
        int i = 0;
        for (; i < 7; ++i) {
